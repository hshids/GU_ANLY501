...
#Look at best values for k using gap-statistics
# Gap Statistic for K means
def optimalK(data, nrefs, maxClusters=15):
    """
...
score_g, df = optimalK(df, nrefs=7, maxClusters=10)
plt.plot(df['clusterCount'], df['gap'], linestyle='--', marker='o', color='b');
plt.xlabel('K');
plt.ylabel('Gap Statistic');
plt.title('Gap Statistic vs. K means');
